...
// Lazy-loaded: owns the ~46KB (gzip) world-map geometry, so mapless pages and
// the home page never download it. See src/LocatorMap.jsx.
...
// C (color palette) now lives in ./theme and is imported at the top.
...
const SUBTYPE_SECTIONS = {
  ...
  "Threshold Moment":["thePivot","theRecord","context","secondOrderEffects","longShadow","causation"],
  ...
  "Non-narrative":     ["theWork","momentOfMaking","whatItDoes","whatItChanged","howBeenRead"],
...
const SECTION_LABELS = {
  ...
  whatMovedThrough:"What Moved Through It", whatMovedThroughIt:"What Moved Through It", whoOrganizedIt:"Who Organized It",
...
// LocatorMap moved to ./LocatorMap.jsx and is lazy-loaded (see the top of this
// file) so its ~46KB (gzip) world geometry only downloads on map pages.
  ...
  return (
    <div>
      ...
      <div style={{ background:C.surface, border:`1px solid ${C.border}`, borderRadius:10, padding: isMobile ? "24px 16px" : "36px 40px" }}>
        {tab === "content" ? (
          <>
            {showMap && <React.Suspense fallback={null}><LocatorMap geo={entry.geo} accent={accent} /></React.Suspense>}
